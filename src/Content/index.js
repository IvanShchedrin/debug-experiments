...
const Content = () => (
  <div className="page-content">
    <div className="scroll-to-anchor" id="scroll-to-anchor"/>
    <article>
      <p>
    ...
    <article>
      ...
      <p>
        Wondering how the iPhone SE compares to the old iPhone SE? Read our comparison of the old and new iPhone SE here.
      </p>
    </article>
    <article>
      <h3>
      ...
      <p>
        ...
        <br /><br />
        <img src="/iphone_se.jpg" alt="" />
        <img src="/iphone_se.png" alt="" />
      </p>
    </article>
    <article>
      <h3>
